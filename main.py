...
#### FILL THIS ####
image_path = '../maps/kelapa-gading-filtered.png'
print('Masukkan path image yang ada di /maps/ ')
image_path = str(input("(masukan input dengan file extensionnya) (ex: pantjoran-fix-filtered.png): "))
image_path = './maps/' + image_path
###################
